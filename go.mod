module github.com/upcloud-tools/karpenter-provider-upcloud
...
replace sigs.k8s.io/karpenter => github.com/aardbol/karpenter v0.0.0-20260818162253-b5f0a3cab686
